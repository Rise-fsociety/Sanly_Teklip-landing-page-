  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 relative z-10 bg-white">
        ...
        <div
          className="relative flex h-[600px] w-full items-center justify-center overflow-hidden rounded-3xl border bg-slate-50/50 p-10 md:shadow-inner"
          ref={containerRef}
        >
          <div className="absolute z-10  top-10 flex flex-col items-center justify-center gap-2">
            <Circle
              ref={akhasapRef}
              className="size-16 shadow-slate-200 p-3 bg-white"
            >
              <Image
                src="/Akhasap.png"
                alt="Akhasap"
          ...
          <div className="flex size-full items-center justify-between gap-10 max-w-4xl mt-12">
            <div className="flex flex-col justify-between h-full py-10">
              <div className="flex flex-col items-center gap-2">
                <Circle ref={nextRef} className="size-16 shadow-slate-200 p-3">
              ...
              <div className="flex flex-col items-center gap-2">
                <Circle
                  ref={flutterRef}
                  className="size-16 shadow-blue-100 p-3"
                >
              ...
              <div className="flex flex-col items-center gap-2">
                <Circle ref={vueRef} className="size-16 shadow-emerald-100 p-3">
            ...
            <div
              ref={centerRef}
              className="z-10 flex size-32 md:size-40 items-center justify-center rounded-full border-4 border-brand-blue bg-white p-6 shadow-2xl shadow-blue-200/50"
            >
              <Image
                src="/Logo.png"
                alt="Sanly Teklip"
            ...
            <div className="flex flex-col justify-between h-full py-10">
              <div className="flex flex-col items-center gap-2">
                <Circle ref={nodeRef} className="size-16 shadow-green-100 p-3">
              ...
              <div className="flex flex-col items-center gap-2">
                <Circle ref={pgRef} className="size-16 shadow-indigo-100 p-3">
              ...
              <div className="flex flex-col items-center gap-2">
                <Circle ref={dockerRef} className="size-16 shadow-blue-100 p-3">
