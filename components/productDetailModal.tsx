      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            <div className="w-full md:w-1/2 bg-white flex flex-col items-center justify-center relative overflow-hidden select-none border-b md:border-b-0 md:border-r border-gray-100 min-h-[340px] md:min-h-0">
                ...
                <div className="flex h-full">
                  {finalImages.map((imgSrc: string, idx: number) => (
                    <div
                      ...
                      <div className="relative w-full h-full max-h-[280px] md:max-h-[420px] bg-white">
                        <Image
                          src={imgSrc}
