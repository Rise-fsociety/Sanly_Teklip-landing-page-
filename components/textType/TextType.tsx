...
import React, { useEffect, useRef, useState, useMemo, useCallback, ElementType } from 'react';
...
const TextType = ({
  ...
  useEffect(() => {
      ...
      if (isDeleting) {
        if (displayedText === '') {
          ...
          if (onSentenceComplete) {
            onSentenceComplete(texts[currentTextIndex], currentTextIndex);
          }
    ...
    pauseDuration, texts, currentTextIndex, loop, initialDelay, isVisible,
    reverseMode, variableSpeed, onSentenceComplete, getRandomSpeed
  ]);

  const shouldHideCursor =
    hideCursorWhileTyping && (currentCharIndex < texts[currentTextIndex].length || isDeleting);
